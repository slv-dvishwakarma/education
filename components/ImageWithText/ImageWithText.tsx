...
export const ImageWithText = () => {
    ...
    return (
        <div className='container relative' id='about-us'>
            <GridBox gap={10} className='xl:space-y-0 lg:space-y-0 md:space-y-0 space-y-5 items-center bg-transparent xl:bg-[linear-gradient(90deg,#FFFFFF00_30%,#F8F8F8_30%)] lg:bg-[linear-gradient(90deg,#FFFFFF00_30%,#F8F8F8_30%)] md:bg-[linear-gradient(90deg,#FFFFFF00_30%,#F8F8F8_30%)] pt-[50px] pb-[70px] mt-10' columns={2}>
                <GridBox.GridItem columnMerge={1} >
                    ...
                    <Image className='hidden xl:block lg:block md:hidden absolute bottom-0 dynamic-movement left-0' src="/images/edumall-shape-grid-dots.png" alt={imageText.title} width={417} height={371} />
                ...
                <GridBox.GridItem columnMerge={1} className='xl:pr-[50px] lg:pr-[50px] md:pr-[50px]'>
                    <h3 className='relative proxima text-[32px] font-bold leading-[1.5em] text-primary pl-[60px] before:content-[""] before:w-[50px] before:h-[3px] before:bg-primary before:absolute before:-translate-y-2/4 before:left-0 before:top-2/4'>{imageText.title}</h3>
                    <p className='mt-3 text-[16px] leading-[30px] md:text-[17px] md:leading-[32px] proxima text-slate-700 text-balance'>{imageText.description}</p>
                </GridBox.GridItem>
            </GridBox>
        </div>
    )
