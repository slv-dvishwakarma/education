<<<<<<< HEAD:components/ImageWithText/ImageWithText.tsx
...
>>>>>>> 9171ee84c154ce2536141180df39532bd168d915:components/home/ImageWithText/ImageWithText.tsx
        ...
        <div className='relative' id='about-us'>
            <GridBox gap={10} className='container  xl:space-y-0 lg:space-y-0 md:space-y-0 space-y-5 items-center xl:bg-transparent lg:bg-transparent md:bg-[#F8F8F8] bg-[#F8F8F8]  xl:bg-[linear-gradient(90deg,#FFFFFF00_30%,#F8F8F8_30%)] lg:bg-[linear-gradient(90deg,#FFFFFF00_30%,#F8F8F8_30%)] md:bg-[linear-gradient(90deg,#FFFFFF00_30%,#F8F8F8_30%)] pt-[50px] pb-[70px] mt-10' columns={2}>
                <GridBox.GridItem columnMerge={1}>
                    ...
                    <Image className='hidden xl:block lg:block md:hidden absolute xl:bottom-0 lg:bottom-[75px] dynamic-movement left-0' src="/images/edumall-shape-grid-dots.png" alt={imageText.title} width={417} height={371} />
                    <div className='hidden xl:block lg:block md:hidden w-[200px] h-[200px] bg-primary absolute rounded-[50%] xl:bottom-0 lg:bottom-[75px] dynamic-movement left-0'></div>
                </GridBox.GridItem>
