...
export const GuidingPrinciple = () => {
    ...
    const data = {
        ...
        description: "“Skilling, reskilling, and upskilling, focusing on the multidimensional approach to make our youth more competitive, is the biggest need of the hour. These endeavours are aimed at making the youngsters flexible and adaptable in the current fast-changing job market.”",
        image: "/images/Narendra-modis.png"
    }


    return (
        <div className='bg-[#121B32] my-[100px] relative xl:pt-0 lg:pt-0 md:pt-0 pt-8'>
            <div className='container '>
                <div className='flex flex-wrap items-center'>
                    ...
                    <div className='xl:w-6/12 lg:w-6/12 md:w-6/12 w-full'>
                        ...
                        <Image className='xl:block lg:block md:block hidden absolute w-[30%] right-0' src="/images/dotted-wave.png" alt={data.title} width={1200} height={894} />
                    </div>
                </div>
            </div>
        </div>
